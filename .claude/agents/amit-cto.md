...
- כל החוקים המלאים: `.cursorrules`. ה-audit הראשוני: `docs/_archive/Architect_Core.md`.

## 📌 Context Routing (חובה)
- נקודות / רמות / Streaks / RPE / Coins → קרא והסתמך **אך ורק** על
  `.claude/knowledge/xp-progression-truth.md`.
- ג'נרטור אימונים / מסלולים / סדר תרגילים / פילטרים → `.claude/knowledge/workout-engine-truth.md`.
