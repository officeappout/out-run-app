...
### ת4 — שיבוץ הוא לא "מילוי חורים"
מצב התחלתי: לוז קיים עם ימים תפוסים.
האירוע: נוספת תוכנית שהחוקים דורשים עבורה מרווח מסוים.
מה צריך לקרות: המנוע רשאי גם להזיז יום קיים, לא רק להוסיף ליום פנוי.
הזזה היא פלט לגיטימי כשהחוקים מחייבים אותה.
בדיקה: הזזת יום קיים אינה נחשבת כשל, כל עוד הלוז אחריה מקיים את כל החוקים.
