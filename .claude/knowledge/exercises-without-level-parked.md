...
| עותק של פיסטול סקוואט שלילי שמאל | `sgrEdIolfxaRCgz8Oqyp` | **לא כפילות** (אומת 15.09.2026 — אין תרגיל "פיסטול סקוואט שלילי שמאל" בלי "עותק של") — מסמך צד-שמאל לא-גמור: חסר `movementGroup`/`tags`/`exerciseRole`/`targetPrograms` לגמרי. משפחת "פיסטול סקוואט" המלאה נסקרה בצ'אט, 15.09.2026 — לא תועדה כקובץ נפרד |
