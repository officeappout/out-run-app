...
const PARK_FALLBACK_IMAGE = '/images/park-placeholder.svg';

function useNearbyParks(isOpen: boolean): NearbyParkCard[] {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        // Silent check — never triggers the browser prompt
