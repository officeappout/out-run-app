...
export const FINANCE_VENDORS_SEED: FinanceVendor[] = [
  ...
  { id: 'software-house-maintenance', name: 'בית תוכנה (Oversight)',    aliases: ['oversight.co.il', 'amit@oversight.co.il', 'אוברסייט', 'Oversight'], expenseNature: 'human_supplier', category: 'פיתוח', paymentMethod: 'ספקים', currency: 'ILS', expectedAmount: 3304, recurring: 'monthly', active: true, notes: 'עמית בראמי · חשבונית מס (PDF או לינק); NOT הצעת מחיר' },
