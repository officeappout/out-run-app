...
import { UserFullProfile, TrainingDomainId } from '@/types/user-profile';
import { ProgressionRule, DomainTrackProgress, MasterProgramProgress } from '@/types/progression-settings.type';
