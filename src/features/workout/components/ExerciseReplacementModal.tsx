...
import { Exercise, ExecutionMethod, RequiredGearType, getLocalizedText } from '@/types/exercise.type';
import { getExerciseVariations, getAlternativeExercises, AlternativeExerciseOption } from '../services/exercise-replacement.service';
import { getGearBadgeProps, getMuscleGroupLabel } from '../utils/gear-mapping.utils';
import { selectExecutionMethodWithBrand } from '../services/execution-method-selector.service';
import { ExecutionLocation } from '@/types/exercise.type';
import { UserFullProfile } from '@/types/user-profile';
import { Park } from '@/types/admin-types';
import { TrendingDown, TrendingUp, Minus, Target, Dumbbell, Radio, Gesture } from 'lucide-react';
