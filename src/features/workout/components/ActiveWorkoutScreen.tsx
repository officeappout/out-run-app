...
import { Exercise as FirestoreExercise, LoggingMode, MovementGroup } from '@/types/exercise.type';
import { WorkoutPlan, WorkoutSegment, Exercise as WorkoutExercise } from '@/features/map/types/map-objects.type';
      ...
      <div className="relative flex-grow w-full overflow-hidden bg-gray-200 dark:bg-gray-800">
        ...
        <div className="absolute top-0 w-full px-4 pt-2 z-20">
          ...
          <div className="flex justify-between items-center text-white text-xs font-semibold">
            <span style={{ fontFamily: 'Assistant, sans-serif' }}>{currentTime}</span>
