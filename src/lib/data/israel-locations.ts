...
export const ISRAELI_LOCATIONS: IsraeliLocation[] = [
  ...
  },
  {
    ...
    population: 108523,
    subLocations: [
      { id: 'hd-ein-hayam', name: 'עין הים', type: 'neighborhood', cluster: 'אולגה' },
      { id: 'hd-givat-olga', name: 'גבעת אולגה', type: 'neighborhood', cluster: 'אולגה' },
      { id: 'hd-beit-eliezer', name: 'בית אליעזר', type: 'neighborhood', cluster: 'בית אליעזר' },
      { id: 'hd-center', name: 'מרכז העיר', type: 'neighborhood', cluster: 'מרכז העיר' },
      { id: 'hd-weizmann', name: 'שכונת ויצמן', type: 'neighborhood', cluster: 'נווה חיים רבתי' },
      // ── Hadera neighborhood reconcile, held for review (official municipal ArcGIS "מפת שכונות חדרה" layer, 36 polygons, clean מתחם cluster field). ──
      { id: 'hd-efraim', name: 'אפריים', type: 'neighborhood', cluster: 'מרכז העיר' },
      { id: 'hd-givat-bosel', name: 'גבעת בוסל', type: 'neighborhood', cluster: 'מרכז העיר' },
      { id: 'hd-yoseftal', name: 'יוספטל', type: 'neighborhood', cluster: 'מרכז העיר' },
      { id: 'hd-rambam', name: 'רמב״ם', type: 'neighborhood', cluster: 'מרכז העיר' },
      { id: 'hd-bialik', name: 'ביאליק', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-brandeis', name: 'ברנדייס', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-nisan', name: 'ניסן', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-paar', name: 'פאר', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-hadera-hatzeira', name: 'שיכון עובדים / חדרה הצעירה', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-shlomo', name: 'שלמה', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-shimshon', name: 'שמשון', type: 'neighborhood', cluster: 'מרכז העיר דרום' },
      { id: 'hd-beitar', name: 'בית״ר', type: 'neighborhood', cluster: 'מרכז העיר מערב' },
      { id: 'hd-ganei-alon', name: 'גני אלון', type: 'neighborhood', cluster: 'מרכז העיר מערב' },
      { id: 'hd-hazeitim', name: 'הזיתים', type: 'neighborhood', cluster: 'מרכז העיר מערב' },
      { id: 'hd-givat-bilu', name: 'גבעת ביל״ו', type: 'neighborhood', cluster: 'מרכז העיר צפון' },
      { id: 'hd-haotzar', name: 'האוצר', type: 'neighborhood', cluster: 'מרכז העיר צפון' },
      { id: 'hd-neve-oved', name: 'נווה עובד', type: 'neighborhood', cluster: 'מרכז העיר צפון' },
      { id: 'hd-nechaliel', name: 'נחליאל', type: 'neighborhood', cluster: 'מרכז העיר צפון' },
      { id: 'hd-hanasi-tzafon', name: 'רח׳ הנשיא צפון', type: 'neighborhood', cluster: 'מרכז העיר צפון' },
      { id: 'hd-yitzhak', name: 'יצחק', type: 'neighborhood', cluster: 'נווה חיים רבתי' },
      { id: 'hd-neve-chaim', name: 'נווה חיים', type: 'neighborhood', cluster: 'נווה חיים רבתי' },
      { id: 'hd-hapoel-hamizrachi', name: 'הפועל המזרחי', type: 'neighborhood', cluster: 'נווה חיים רבתי' },
      { id: 'hd-hefziba', name: 'חפציבה', type: 'neighborhood', cluster: 'חפציבה' },
      { id: 'hd-achuzat-dania', name: 'אחוזת דניה', type: 'neighborhood', cluster: 'בית אליעזר' },
      { id: 'hd-hapark', name: 'הפארק', type: 'neighborhood', cluster: 'הפארק' },
      { id: 'hd-hapark-tzafon-vatik', name: 'הפארק - צפון ותיק', type: 'neighborhood', cluster: 'הפארק' }
    ]
  },
  {
    id: 'modiin',
