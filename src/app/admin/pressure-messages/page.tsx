...
const CATEGORY_COLORS: Record<MessageCategory, string> = {
  ...
  company_outreach:        'bg-sky-100 text-sky-700 border-sky-200',
  youth_movement_outreach: 'bg-emerald-100 text-emerald-700 border-emerald-200',
};
