...
import { getExercise, updateExercise } from '@/features/admin/services/exercise.service';
import { Exercise, ExerciseFormData, getLocalizedText } from '@/types/exercise.type';
