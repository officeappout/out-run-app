...
import ResultLoading from '@/features/onboarding/components/ResultLoading';
import ProgramResult from '@/features/onboarding/components/ProgramResult';
  ...
  const handleComplete = useCallback(async () => {
    try {
      ...
      if (!levelNumber && assignedLevelId) {
        const { getLevel } = await import('@/features/admin/services/level.service');
